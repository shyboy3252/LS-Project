...
GCC_SPECS := D:/APP/LoongIDE/mips-2011.03/mips-sde-elf/ls1b200
OS := bare
...
$(OUT_ELF): $(STARTO) $(OBJS) $(USER_OBJS)
	...
	D:/APP/LoongIDE/mips-2011.03/bin/mips-sde-elf-gcc.exe  -mips32 -G0 -EL -msoft-float -nostartfiles -static -T $(LINKCMDS) -o $(OUT_ELF) -e start $(STARTO) $(OBJS) $(USER_OBJS) $(LIBS) 
	@echo 'Invoking: SDE Lite C Objcopy'
	D:/APP/LoongIDE/mips-2011.03/bin/mips-sde-elf-objcopy.exe -O binary $(OUT_ELF) $(OUT_BIN)
	@echo 'Invoking: SDE Lite C Size'
	D:/APP/LoongIDE/mips-2011.03/bin/mips-sde-elf-size.exe $(OUT_ELF)
